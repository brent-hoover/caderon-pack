...
5. **Create the worktree.** Derive the slug from the ticket title: lowercase, replace spaces and
   non-alphanumeric characters with hyphens, strip leading/trailing hyphens, truncate to 40 chars
