...
<List every `.feature` file written for this feature. These files are the executable definition of
done — implementation is complete when all scenarios pass.>

| Feature file | Behavior proven |
|---|---|
| `scenarios/<name>.feature` | <One-line description of the behavior> |

Run all scenarios: `<pytest scenarios/ OR godog ./scenarios/>`
